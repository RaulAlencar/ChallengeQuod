...
fun FacialBiometricScreen(navController: NavController) {
    ...
    Box(
        ...
        Column(
            ...
            // Imagem e cabeçalho
            Image(
                painter = painterResource(id = R.drawable.bio_facial), // Referência para a sua imagem
...
// Preview para a tela FacialBiometricScreen
@Composable
@Preview(showBackground = true)
fun PreviewFacialBiometricScreen() {
    // A navegação não precisa estar configurada para o preview. Podemos passar um mock do NavController.
    FacialBiometricScreen(navController = NavController(LocalContext.current)) // Use um NavController fictício ou mock.
}
